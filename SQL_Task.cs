...
class Program
{
    ...
    static void Main()
    {
        var actions = new Dictionary<int, Action>{{1, AddFullTimeEmployee},
        {2, AddContractEmployee},
        {3, ViewAllEmployees},
        {4, SearchByDepartment},
        {5, SortBySalary},
        {6, DeleteEmployee},
        {7, BonusFeatures},{9, FetchFromDatabase}};
    ...
    static void DeleteEmployee()
    {
        ...
        if (removed == 0) Console.WriteLine("Employee not found!");
        else Console.WriteLine("Employee deleted successfully!");
    }
